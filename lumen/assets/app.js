...
(function () {
  ...
  /* The Lumen Standard v2.0 deterministic rule (assets/lumen-standard.js, loaded
     before this script). Resolved once so evidenceHTML stays textually identical
     to its build-time twin in lib/story-render.js. */
  var STD = (typeof window !== 'undefined' && window.LUMEN_STANDARD) || null;
